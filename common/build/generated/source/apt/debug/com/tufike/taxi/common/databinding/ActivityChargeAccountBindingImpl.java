...
public class ActivityChargeAccountBindingImpl extends ActivityChargeAccountBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.payment_toggle_layout, 3);
        sViewsWithIds.put(R.id.checkout_button, 4);
        sViewsWithIds.put(R.id.layout_charges, 5);
        sViewsWithIds.put(R.id.charge_add_first, 6);
        sViewsWithIds.put(R.id.charge_add_second, 7);
        sViewsWithIds.put(R.id.charge_add_third, 8);
        sViewsWithIds.put(R.id.price_text_layout, 9);
    ...
    private ActivityChargeAccountBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 0
            ...
            , (com.savvyapps.togglebuttonlayout.ToggleButtonLayout) bindings[3]
