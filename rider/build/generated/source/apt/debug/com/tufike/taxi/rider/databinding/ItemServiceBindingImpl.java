...
public class ItemServiceBindingImpl extends ItemServiceBinding  {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.item == variableId) {
            setItem((com.tufike.taxi.common.models.Service) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setItem(@Nullable com.tufike.taxi.common.models.Service Item) {
        this.mItem = Item;
        synchronized(this) {
            mDirtyFlags |= 0x1L;
        }
    ...
    protected void executeBindings() {
        ...
        com.tufike.taxi.common.models.Service item = mItem;
        ...
        if ((dirtyFlags & 0x3L) != 0) {
            ...
            androidx.databinding.adapters.TextViewBindingAdapter.setText(this.textCost, textCostAndroidStringServiceCardCostItemCost);
